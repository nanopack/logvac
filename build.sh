...
# build logvac
echo "Building LOGVAC and uploading it to 's3://tools.nanopack.io/logvac'"
...
aws s3 sync ./build/ s3://tools.nanopack.io/logvac --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers --region us-east-1
